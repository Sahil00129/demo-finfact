...
<div class="nav-logo align-self-center">
    <a class="navbar-brand" href="{{url('home')}}"><img alt="logo" src="{{asset('assets/img/f15.png')}}" style="margin-bottom:14px;"> </a>
</div>
        ...
        <nav id="topbar">
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{{url('home')}}">
                        <img src="{{asset('assets/img/fin.png')}}" class="navbar-logo" alt="logo">
                    </a>
                </li>
            ...
            <ul class="list-unstyled menu-categories" id="topAccordion">
                ...
                <a href="#more" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    ...
                    <ul class="collapse submenu list-unstyled animated fadeInUp" id="more"  data-parent="#topAccordion">
                        @can('user-list')
                        <li>
                            <a href="{{url('users')}}">Transcations Sheets</a>
                        </li>
                        @endcan
                        @can('role-list')
                        <li>
...
<ul class="navbar-item flex-row nav-dropdowns">
    <li class="nav-item dropdown language-dropdown more-dropdown">
        <div class="dropdown custom-dropdown-icon">
            <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('assets/img/ind.png')}}" class="flag-width" alt="flag">
            </a>
